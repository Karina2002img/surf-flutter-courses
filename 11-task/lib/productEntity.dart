...
Map<Category, List<ProductEntity>> groupByCategory(List<ProductEntity> products) {
  Map<Category, List<ProductEntity>> result = {};
...
Map<Category, List<ProductEntity>> groupedProducts = groupByCategory(dataForStudents);